...
public class SetOdometry extends CommandBase {
   ...
   */
  public SetOdometry(RomiDrivetrain driveTrain, Pose2d pose2d) {
    this(driveTrain, null, pose2d);
  }

  public SetOdometry(RomiDrivetrain driveTrain, FieldSim fieldSim, Pose2d pose2d) {
  ...
  public void initialize() {
      m_driveTrain.resetOdometry(m_pose2d);
