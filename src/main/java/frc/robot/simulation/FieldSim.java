...
public class FieldSim {
    ...
    public FieldSim(RomiDrivetrain driveTrain) {
    ...
    public void initSim() {
        ...
        Pose2d startPosition = new Pose2d(Units.inchesToMeters(40), Units.inchesToMeters(90), new Rotation2d(Units.degreesToRadians(0)));
